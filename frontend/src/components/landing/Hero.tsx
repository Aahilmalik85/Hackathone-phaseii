...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 bg-background-primary">
      {/* Gradient background */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0f1f0f] via-[#1a2b2a] to-[#102020]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(135,206,235,0.1),transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(70,130,180,0.1),transparent_50%)]" />
      </div>
      ...
      >
        ...
        <motion.div variants={staggerItemVariants} className="inline-flex mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background-elevated/60 backdrop-blur-sm border border-border-default">
        ...
        <motion.h1
          ...
          className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-text-primary mb-6 leading-tight"
        >
          Organize Your Life
          <br />
        ...
        >
          A modern, sky-themed todo application for productivity.
          ...
          <Link href="/auth/signup">
           <Button
             ...
             rightIcon={<ArrowRight size={20} />}
               ...
               text-white shadow-lg shadow-sky-400/40
