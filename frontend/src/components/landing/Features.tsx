...
export default function Features() {
  return (
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-background-primary/90">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-sky-200 max-w-2xl mx-auto font-sans">
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div key={index} variants={staggerItemVariants}>
                <Card variant="elevated" hover className="h-full p-6 bg-background-secondary/80">
                  <CardContent className="p-0">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-semibold text-sky-400 mb-2 font-sans">
                          {feature.title}
                        </h3>
                        <p className="text-sky-200 leading-relaxed font-sans">
                          {feature.description}
                        </p>
                      </div>
                    </div>
